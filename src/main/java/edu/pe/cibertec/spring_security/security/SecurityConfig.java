package edu.pe.cibertec.spring_security.security;
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain suSecurityFilterChain(HttpSecurity httpSecurity)
            throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    // PERMITIMOS EL ACCESO DESDE CUALQUIER MEDIO
